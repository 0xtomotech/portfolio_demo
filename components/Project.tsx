...
function Project({ title, description, tags, imageUrl }: ProjectProps) {
  ...
  return (
    ...
    >
      <section className="group-even-ml-[18rem] relative max-w-[42rem] overflow-hidden rounded-lg border border-black/5 bg-gray-100 transition hover:bg-gray-200 sm:h-[20rem] sm:pr-8">
